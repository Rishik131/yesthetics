    ...
    <>
        <div ref={props.aboutRef} className="container">
            ...
            <div className="item2">
                <div className="item2_1">
                    ...
                    <div data-aos="fade-left" className="item2_3">
                        ...
                        <img src="src/assets/images/facial.jpg" alt="Face" width={450} />
                    </div>
                </div>
            </div>
            <div className="item3">
            <div className="item3_1">
                    ...
                    <img data-aos="fade-right" src="src\assets\images\hair.jpg" alt="Face" width={450} />
            ...
            <div className="item4_1">
                    ...
                    <div  data-aos="fade-left" className="item4_3">
                        ...
                        <img src="src\assets\images\teeth.jpg" alt="Face" width={450} />
                    </div>
                </div>
            </div>
        </div>
